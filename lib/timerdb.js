...
var db = new sqlite3.Database('/simojs-data/simojs.sqlite', function(err) {
    if (err) {
        console.log('TimerDB:', 'could not open database file from: /simojs-data/simojs.sqlite');
        console.log('Using in-memory database instead');
        return new sqlite3.Database(':memory:');
    } else {
        console.log("TimerDB: persistent db opened")
    }
});
